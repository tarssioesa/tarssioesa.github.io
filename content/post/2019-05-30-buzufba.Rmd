...
Infelizmente, eu não consegui por as equações via latex, mas segue uma imagem que fala um pouco sobre a mudança do equacionamento do Índice GINI que o torna adequado para variáveis ordinais: 
